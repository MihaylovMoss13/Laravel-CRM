    ...
    [
      ...
      _c(
        "b-modal",
        {
          ...
          attrs: { "hide-footer": "", title: "Добавить новую категорию" }
        },
        [
                  ...
                  _c("input", {
                    ...
                    on: {
                      input: function($event) {
                        ...
                        _vm.$set(_vm.categoryData, "title", $event.target.value)
                      }
                    }
                  })
                ]),
      ...
      _c("div", { staticClass: "table-responsive" }, [
        _c(
          ...
          [
            ...
            _c("tbody", [
              _c("tr", [
                _c("td", [_vm._v("Первая категория")]),
                _vm._v(" "),
                _c("td", [_vm._v("Картинка")])
              ]),
              _vm._v(" "),
              _c("tr", [
                _c("td", [_vm._v("Вторая категория")]),
                _vm._v(" "),
                _c("td", [_vm._v("Картинка")])
              ])
            ])
